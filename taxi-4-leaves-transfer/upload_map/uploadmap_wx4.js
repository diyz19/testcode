...
const POSITION = `${MAP_NAME}111111111111`.slice(0, 14);

var Web3 = require('web3');
var json = require("../Contracts/artifacts/StoreMap.json");
var contract = require("truffle-contract");
var MyContract = contract(json);

// Step 3: Provision the contract with a web3 provider
// MyContract.setProvider(new Web3.providers.HttpProvider("http://localhost:" + PORT));
MyContract.setProvider(new Web3.providers.HttpProvider("http://localhost:" + 8081));


// contract address
var myContractInstance = MyContract.at("0x23b98f92ceac005e570b6768da377b3abd11012e");
var account = "0x196424dd2bf7c978228ebd7a17b38b993d650696";

// read map in json format
var fs = require('fs');
// var map_file="./BeijingData.json";
// var map_file = "./costMap_GeoHash.json";
var map_file = "./out_" + MAP_NAME + ".json";
...
async function add_area_line(geohash, gid, gas, retry_times) {
	...
	await myContractInstance.add_area_line(geohash, gid, { from: account, gas: gas, position: POSITION, txtime: 278000 }).then(function (result) {
		// console.log(result);
	},
		function (err) {
...
async function add_oneline(gid, minzoom, cost, source, target, oneway, building, highway, name, gtype, path, gas, retry_times) {
	...
	await myContractInstance.add_onetype(gid, minzoom, cost, source, target, oneway, building, highway, name, gtype, path, { from: account, gas: gas, position: POSITION, txtime: 278000 }).then(function (result) {
		console.log("gid: ", gid);
