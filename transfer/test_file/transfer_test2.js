...
function Tx_common_w12() {
	...
	w12Web3.eth.sendTransaction({ from: macc1, to: minerW12, position: "w1201111111111", txtime: 1100 }, function (err, res) {
		if (err) {
...
function Tx_common_w12_single() {
	...
	sleep(200)
	w12Web3.eth.sendTransaction({ from: macc2, to: minerW12, position: "w1202111111111", txtime: 1200 }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
			console.log("!!macc2--insufficient funds for this tx--w12!!")
		}
	...
	sleep(200)
	w12Web3.eth.sendTransaction({ from: macc3, to: minerW12, position: "w1203111111111", txtime: 1300 }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
			console.log("!!macc3--insufficient funds for this tx--w12!!")
		}
	...
	sleep(200)
	w12Web3.eth.sendTransaction({ from: macc4, to: minerW12, position: "w1204111111111", txtime: 1400 }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
			console.log("!!macc4--insufficient funds for this tx--w12!!")
		}
	...
	sleep(200)
	w12Web3.eth.sendTransaction({ from: macc5, to: minerW12, position: "w1205111111111", txtime: 1500 }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
			console.log("!!macc5--insufficient funds for this tx--w12!!")
		}
	...
	sleep(200)
	w12Web3.eth.sendTransaction({ from: macc6, to: minerW12, position: "w1206111111111", txtime: 1600 }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
			console.log("!!macc6--insufficient funds for this tx--w12!!")
		}
	...
	sleep(200)
	w12Web3.eth.sendTransaction({ from: macc7, to: minerW12, position: "w1207111111111", txtime: 1700 }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
			console.log("!!macc7--insufficient funds for this tx--w12!!")
		}
	...
	sleep(200)
	w12Web3.eth.sendTransaction({ from: macc8, to: minerW12, position: "w1208111111111", txtime: 1800 }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
			console.log("!!macc8--insufficient funds for this tx--w12!!")
		}
	...
	sleep(200)
	w12Web3.eth.sendTransaction({ from: macc9, to: minerW12, position: "w1209111111111", txtime: 1900 }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
			console.log("!!macc9--insufficient funds for this tx--w12!!")
		}
	...
	sleep(200)
	w12Web3.eth.sendTransaction({ from: macc10, to: minerW12, position: "w1210111111111", txtime: 2000 }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
			console.log("!!macc10--insufficient funds for this tx--w12!!")
		}
...
function Tx_request_w12_single() {
	...
	sleep(2000)
	// starttime = Date.now();
	w12Web3.eth.sendTransaction({ from: macc1, to: accountManagerW11, position: "w1211111111111", txtype: 1, txtime: 2100 }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req1 = w12Web3.toHex(res);
			console.log("macc1_hash_req:", hash_req1);
		}
	});
	w12Web3.eth.sendTransaction({ from: macc2, to: accountManagerW11, position: "w1212111111111", txtype: 1, txtime: 2200 }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req2 = w12Web3.toHex(res);
			console.log("macc2_hash_req:", hash_req2);
		}
	});
	w12Web3.eth.sendTransaction({ from: macc3, to: accountManagerW11, position: "w1213111111111", txtype: 1, txtime: 2300 }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req3 = w12Web3.toHex(res);
			console.log("macc3_hash_req:", hash_req3);
		}
	});
	w12Web3.eth.sendTransaction({ from: macc4, to: accountManagerW11, position: "w1214111111111", txtype: 1, txtime: 2400 }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req4 = w12Web3.toHex(res);
			console.log("macc4_hash_req:", hash_req4);
		}
	});
	w12Web3.eth.sendTransaction({ from: macc5, to: accountManagerW11, position: "w1215111111111", txtype: 1, txtime: 2500 }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req5 = w12Web3.toHex(res);
			console.log("macc5_hash_req:", hash_req5);
		}
	});
	w12Web3.eth.sendTransaction({ from: macc6, to: accountManagerW11, position: "w1216111111111", txtype: 1, txtime: 2600 }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req6 = w12Web3.toHex(res);
			console.log("macc6_hash_req:", hash_req6);
		}
	});
	w12Web3.eth.sendTransaction({ from: macc7, to: accountManagerW11, position: "w1217111111111", txtype: 1, txtime: 2700 }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req7 = w12Web3.toHex(res);
			console.log("macc7_hash_req:", hash_req7);
		}
	});
	w12Web3.eth.sendTransaction({ from: macc8, to: accountManagerW11, position: "w1218111111111", txtype: 1, txtime: 2800 }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req8 = w12Web3.toHex(res);
			console.log("macc8_hash_req:", hash_req8);
		}
	});
	w12Web3.eth.sendTransaction({ from: macc9, to: accountManagerW11, position: "w1219111111111", txtype: 1, txtime: 2900 }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req9 = w12Web3.toHex(res);
			console.log("macc9_hash_req:", hash_req9);
		}
	});
	w12Web3.eth.sendTransaction({ from: macc10, to: accountManagerW11, position: "w1220111111111", txtype: 1, txtime: 3000 }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req10 = w12Web3.toHex(res);
...
function Tx_common_w12tow11() {
	...
	w11Web3.eth.sendTransaction({ from: macc1, to: minerW11, position: "w1121111111111", txtime: curtime }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
	...
	sleep(200)
	curtime = new Date().getTime();
	w11Web3.eth.sendTransaction({ from: macc2, to: minerW12, position: "w1122111111111", txtime: curtime }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
	...
	sleep(200)
	curtime = new Date().getTime();
	w11Web3.eth.sendTransaction({ from: macc3, to: minerW12, position: "w1123111111111", txtime: curtime }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
	...
	sleep(200)
	curtime = new Date().getTime();
	w11Web3.eth.sendTransaction({ from: macc4, to: minerW12, position: "w1124111111111", txtime: curtime }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
	...
	sleep(200)
	curtime = new Date().getTime();
	w11Web3.eth.sendTransaction({ from: macc5, to: minerW12, position: "w1125111111111", txtime: curtime }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
	...
	sleep(200)
	curtime = new Date().getTime();
	w11Web3.eth.sendTransaction({ from: macc6, to: minerW12, position: "w1126111111111", txtime: curtime }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
	...
	sleep(200)
	curtime = new Date().getTime();
	w11Web3.eth.sendTransaction({ from: macc7, to: minerW12, position: "w1127111111111", txtime: curtime }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
	...
	sleep(200)
	curtime = new Date().getTime();
	w11Web3.eth.sendTransaction({ from: macc8, to: minerW12, position: "w1128111111111", txtime: curtime }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
	...
	sleep(200)
	curtime = new Date().getTime();
	w11Web3.eth.sendTransaction({ from: macc9, to: minerW12, position: "w1129111111111", txtime: curtime }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
	...
	sleep(200)
	curtime = new Date().getTime();
	w11Web3.eth.sendTransaction({ from: macc10, to: minerW12, position: "w1130111111111", txtime: curtime }, function (err, res) {
		if (err) {
			//console.log("Error:",err);
...
function Tx_request_w11_single() {
	...
	sleep(2000)
	curtime = Date.now();
	w11Web3.eth.sendTransaction({ from: macc1, to: accountManagerW11, position: "w1151111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req1 = w11Web3.toHex(res);
			console.log("w11_macc1_hash_req:", hash_req1);
		}
	});
	w11Web3.eth.sendTransaction({ from: macc2, to: accountManagerW11, position: "w1152111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req2 = w11Web3.toHex(res);
			console.log("w11_macc2_hash_req:", hash_req2);
		}
	});
	w11Web3.eth.sendTransaction({ from: macc3, to: accountManagerW11, position: "w1153111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req3 = w11Web3.toHex(res);
			console.log("w11_macc3_hash_req:", hash_req3);
		}
	});
	w11Web3.eth.sendTransaction({ from: macc4, to: accountManagerW11, position: "w1154111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req4 = w11Web3.toHex(res);
			console.log("w11_macc4_hash_req:", hash_req4);
		}
	});
	w11Web3.eth.sendTransaction({ from: macc5, to: accountManagerW11, position: "w1155111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req5 = w11Web3.toHex(res);
			console.log("w11_macc5_hash_req:", hash_req5);
		}
	});
	w11Web3.eth.sendTransaction({ from: macc6, to: accountManagerW11, position: "w1156111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req6 = w11Web3.toHex(res);
			console.log("w11_macc6_hash_req:", hash_req6);
		}
	});
	w11Web3.eth.sendTransaction({ from: macc7, to: accountManagerW11, position: "w1157111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req7 = w11Web3.toHex(res);
			console.log("w11_macc7_hash_req:", hash_req7);
		}
	});
	w11Web3.eth.sendTransaction({ from: macc8, to: accountManagerW11, position: "w1158111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req8 = w11Web3.toHex(res);
			console.log("w11_macc8_hash_req:", hash_req8);
		}
	});
	w11Web3.eth.sendTransaction({ from: macc9, to: accountManagerW11, position: "w1159111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req9 = w11Web3.toHex(res);
			console.log("w11_macc9_hash_req:", hash_req9);
		}
	});
	w11Web3.eth.sendTransaction({ from: macc10, to: accountManagerW11, position: "w1160111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
			hash_req10 = w11Web3.toHex(res);
...
function Tx_request_w12_single() {
	...
	sleep(2000)
	curtime = Date.now();
	w12Web3.eth.sendTransaction({ from: macc1, to: accountManagerW11, position: "w1241111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
	...
	w12Web3.eth.sendTransaction({ from: macc2, to: accountManagerW11, position: "w1242111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
	...
	w12Web3.eth.sendTransaction({ from: macc3, to: accountManagerW11, position: "w1243111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
	...
	w12Web3.eth.sendTransaction({ from: macc4, to: accountManagerW11, position: "w1244111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
	...
	w12Web3.eth.sendTransaction({ from: macc5, to: accountManagerW11, position: "w1245111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
	...
	w12Web3.eth.sendTransaction({ from: macc6, to: accountManagerW11, position: "w1246111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
	...
	w12Web3.eth.sendTransaction({ from: macc7, to: accountManagerW11, position: "w1247111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
	...
	w12Web3.eth.sendTransaction({ from: macc8, to: accountManagerW11, position: "w1248111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
	...
	w12Web3.eth.sendTransaction({ from: macc9, to: accountManagerW11, position: "w1249111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
	...
	w12Web3.eth.sendTransaction({ from: macc10, to: accountManagerW11, position: "w1250111111111", txtype: 1, txtime: curtime }, function (err, res) {
		if (err) {
			console.log("Error:", err);
		} else {
			sleep(2000)
...
exports.init_tx = function () {
	//10个账户,初始余额为0	
	console.log("balance_init_macc1:", w11Web3.eth.getBalance(macc1))
	console.log("balance_init_macc2:", w11Web3.eth.getBalance(macc2))
	console.log("balance_init_macc3:", w11Web3.eth.getBalance(macc3))
	console.log("balance_init_macc4:", w11Web3.eth.getBalance(macc4))
	console.log("balance_init_macc5:", w11Web3.eth.getBalance(macc5))
	console.log("balance_init_macc6:", w11Web3.eth.getBalance(macc6))
	console.log("balance_init_macc7:", w11Web3.eth.getBalance(macc7))
	console.log("balance_init_macc8:", w11Web3.eth.getBalance(macc8))
	console.log("balance_init_macc9:", w11Web3.eth.getBalance(macc9))
	console.log("balance_init_macc10:", w11Web3.eth.getBalance(macc10))
	...
	//10个账户,余额为10000	
	console.log("balance_beforetrans_macc1:", w11Web3.eth.getBalance(macc1))
	console.log("balance_beforetrans_macc2:", w11Web3.eth.getBalance(macc2))
	console.log("balance_beforetrans_macc3:", w11Web3.eth.getBalance(macc3))
	console.log("balance_beforetrans_macc4:", w11Web3.eth.getBalance(macc4))
	console.log("balance_beforetrans_macc5:", w11Web3.eth.getBalance(macc5))
	console.log("balance_beforetrans_macc6:", w11Web3.eth.getBalance(macc6))
	console.log("balance_beforetrans_macc7:", w11Web3.eth.getBalance(macc7))
	console.log("balance_beforetrans_macc8:", w11Web3.eth.getBalance(macc8))
	console.log("balance_beforetrans_macc9:", w11Web3.eth.getBalance(macc9))
	console.log("balance_beforetrans_macc10:", w11Web3.eth.getBalance(macc10))
...
exports.get_outchain_info = function (acc, outchain) {
	...
	if (outchain === 'w11') {
		...
		macc_outbal = w11Web3.eth.getBalance(curacc)
		...
		console.log("curacc:", curacc)
		macc_outbal = w12Web3.eth.getBalance(curacc)
