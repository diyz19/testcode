...
geth-tree --identity "MyEth" --rpc --rpcport "8511" --rpccorsdomain "*" --datadir gethdata --port "30311" --nodiscover --rpcapi "eth,net,personal,web3,miner" --networkid "w11" --allow-insecure-unlock --dev.period 1 --preload "../test_file/w11_addPeer.js" console
