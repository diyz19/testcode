...
// contract address 
var myContractInstance = MyContract.at("0xe833aa0b362cb6fc9c04d5e45e60b5b9a106be64");
var account = "0x196424dd2bf7c978228ebd7a17b38b993d650696";

// read map in json format
var fs = require('fs');
// var map_file="./BeijingData.json";out_wx4en.json
...
async function add_area_line(geohash, gid, gas, retry_times) {
	...
	await myContractInstance.add_area_line(geohash, gid, { from: account, gas: gas, position: "wx411111111111", txtime: 278000 }).then(function (result) {
		// console.log(result);
	},
		function (err) {
...
async function add_oneline(gid, minzoom, cost, source, target, oneway, building, highway, name, gtype, path, gas, retry_times) {
	...
	await myContractInstance.add_onetype(gid, minzoom, cost, source, target, oneway, building, highway, name, gtype, path, { from: account, gas: gas, position: "wx411111111111", txtime: 278000 }).then(function (result) {
		console.log("gid: ", gid);
